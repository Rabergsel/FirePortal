...
namespace FirePortal.App.Configuration;
...
{
    [JsonProperty("FirePortal")] public FirePortalData FirePortal { get; set; } = new();

    public class FirePortalData
    {
        [JsonProperty("AppUrl")]
        [Description("The url FirePortal is accesible with from the internet")]
        public string AppUrl { get; set; } = "http://your-FirePortal-url-without-slash";

        [JsonProperty("EnableLatencyCheck")]
        [Description(
            "This will enable a latency check for connections to FirePortal. Users with an too high latency will be warned that FirePortal might be buggy for them")]
    ...
    public class LetsEncrypt
    {
        ...
        public string Organization { get; set; } = "FirePortal Panel";
    }
    ...
    {
        [JsonProperty("Database")] public string Database { get; set; } = "FirePortal_db";
        ...
        [JsonProperty("Username")] public string Username { get; set; } = "FirePortal_user";
    }
    ...
    public class HeadersData
    {
        [JsonProperty("Color")]
        [Description(
            "This specifies the color of the embed generated by platforms like discord when someone posts a link to your FirePortal instance")]
        public string Color { get; set; } = "#4b27e8";

        [JsonProperty("Description")]
        [Description(
            "This specifies the description text of the embed generated by platforms like discord when someone posts a link to your FirePortal instance and can also help google to index your FirePortal instance correctly")]
        public string Description { get; set; } = "the next generation hosting panel";

        [JsonProperty("Keywords")]
        [Description(
            "To help search engines like google to index your FirePortal instance correctly you can specify keywords seperated by a comma here")]
        public string Keywords { get; set; } = "FirePortal";

        [JsonProperty("Title")]
        [Description(
            "This specifies the title of the embed generated by platforms like discord when someone posts a link to your FirePortal instance")]
        public string Title { get; set; } = "FirePortal - endelon.link";
    }
    ...
    public class SecurityData
    {
        [JsonProperty("Token")]
        [Description(
            "This is the FirePortal app token. It is used to encrypt and decrypt data and validate tokens and sessions")]
        [Blur]
        public string Token { get; set; } = Guid.NewGuid().ToString();
    ...
    public class SentryData
    {
        ...
        [JsonProperty("Dsn")]
        [Description("The dsn is the key FirePortal needs to communicate with your sentry instance")]
        [Blur]

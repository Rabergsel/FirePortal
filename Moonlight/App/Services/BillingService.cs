...
using Subscription = FirePortal.App.Database.Entities.Subscription;
...
public class BillingService
{
    ...
    {
        var appUrl = ConfigService.Get().FirePortal.AppUrl;
        var controllerUrl = appUrl + "/api/FirePortal/billing";

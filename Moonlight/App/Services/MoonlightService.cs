...
public class FirePortalService
{
    ...
    public FirePortalService(ConfigService configService)
    {
    ...
    private async Task FetchChangeLog()
    {
        ...
        try
        {
            var client = new GitHubClient(new ProductHeaderValue("FirePortal-Panel"));
            
            var pullRequests = await client.PullRequest.GetAllForRepository("FirePortal-Panel", "FirePortal", new PullRequestRequest
            {

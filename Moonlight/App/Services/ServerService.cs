...
using FirePortal.App.ApiClients.Wings.Requests;
...
using FileAccess = FirePortal.App.Helpers.Files.FileAccess;
...
public class ServerService
{
    ...
    public async Task SetPowerState(Server s, PowerSignal signal)
    {
        ...
        if (ConfigService.Get().FirePortal.Security.MalwareCheckOnStart && signal == PowerSignal.Start ||

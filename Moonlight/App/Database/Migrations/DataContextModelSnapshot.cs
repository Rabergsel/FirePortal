...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FirePortal.App.Database.Entities.BlocklistIp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FirePortal.App.Database.Entities.PermissionGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FirePortal.App.Database.Entities.SecurityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FirePortal.App.Database.Entities.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FirePortal.App.Database.Entities.TicketMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FirePortal.App.Database.Entities.WhitelistIp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FirePortal.App.Database.Entities.Server", b =>
                {
                    b.HasOne("FirePortal.App.Database.Entities.ServerBackup", "Archive")
                        .WithMany()
            ...
            modelBuilder.Entity("FirePortal.App.Database.Entities.Ticket", b =>
                {
                    b.HasOne("FirePortal.App.Database.Entities.User", "AssignedTo")
                        .WithMany()
                        .HasForeignKey("AssignedToId");

                    b.HasOne("FirePortal.App.Database.Entities.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("FirePortal.App.Database.Entities.TicketMessage", b =>
                {
                    ...
                    b.HasOne("FirePortal.App.Database.Entities.Ticket", null)
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("FirePortal.App.Database.Entities.User", b =>
                {
                    ...
                    b.HasOne("FirePortal.App.Database.Entities.PermissionGroup", "PermissionGroup")
                        .WithMany()

...
using FirePortal.App.Http.Requests.Wings;
using FirePortal.App.Http.Resources.Wings;
...
public class SftpAuthController : Controller
{
    ...
    public async Task<ActionResult<SftpLoginResult>> Login(SftpLoginRequest request)
    {
        ...
        if (request.Type == "public_key") // Deny public key authentication, because FirePortal does not implement that
        {
